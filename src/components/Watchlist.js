                    ...
                    <Grid container className="card">
                      ...
                      <Grid item className="dates" xs={12} md={12}>
                        <Typography variant="p">
                          Start Date: {shows.airdate}
                        </Typography>
                      </Grid>

                      <Grid item className="dates" xs={12} md={12}>
                        <Typography variant="p">
                          End Date: {shows.enddate}
                        </Typography>
                      </Grid>
                      ...
                      <Grid item className="releaseDays" xs={12} md={12}>
                        <p>Platforms: </p>
                        {shows.crunchyroll ? (
                          <Typography variant="p">Crunchyroll </Typography>
                        ) : null}
                        {shows.funimation ? (
                          <Typography variant="p">funimation </Typography>
                        ) : null}
                        {shows.netflix ? (
                          <Typography variant="p">Netflix </Typography>
                        ) : null}
                      </Grid>
                    </Grid>
                  </Card>
